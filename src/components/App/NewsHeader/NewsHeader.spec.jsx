...
function setProps({ loading = true, news = [], newsDetailsHoverIn = false }) {
  return {
    loading,
    news,
    newsDetailsHoverIn,
...
function setup({ loading = true, news = [], newsDetailsHoverIn = false }) {
...
describe('News Block', () => {
  describe('when isLoading is true', () => {
    ...
    it('should render only Loader', () => {
      ...
      const wrapper = renderer.create(<NewsHeader {...props} />).toJSON();
  ...
  describe('when isLoading is false', () => {
    ...
    it('should proper invoke call functions on componentDidMount', () => {
      ...
      expect(component.find('NewsDetails').props()).toEqual({
        classAnimation: 'showOff',
        news: []
      });
      expect(component.find('NewsDetails').prop('classAnimation')).toEqual('showOff');
      // Assert: component
