...
describe('filter', () => {
    ...
    describe('reducers', () => {
        it('should dispatch action BLOG_FILTER_WAS_CHANGED', () => {
            const action = {
                type: BLOG_FILTER_WAS_CHANGED, payload: {
                    value: 'some value',
                    type: 'author',
                }
            };
    ...
    describe('actions', () => {
        it('should dispatch action BLOG_FILTER_WAS_CHANGED', () => {
            const action = {type: BLOG_FILTER_WAS_CHANGED, payload: {value: 'Some new family', type: 'author'}};
        ...
        it('should return proper action from filterNewsByTypeAndValue', () => {
            expect(filterNewsByTypeAndValue('id', '123'))
                .toEqual({
